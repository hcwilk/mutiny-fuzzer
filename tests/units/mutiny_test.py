...
class TestMutiny(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.args = Namespace(prepped_fuzz=cls.fuzz_file_path_1, target_host='127.0.0.1', server=False, sleep_time=0, range=None, loop=None, dump_raw=None, quiet=False, log_all=False, testing=True)
    ...
    def setUp(self):
        ...
        self.args = Namespace(prepped_fuzz=self.fuzz_file_path_1, target_host='127.0.0.1', server=False, sleep_time=0, range=None, loop=None, dump_raw=None, quiet=False, log_all=False, testing=True)
