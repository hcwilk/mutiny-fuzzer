    ...
    def accept_fuzz(self):
        ...
        while True:
            ...
            if len(result) == 539:
                ...
                print('below thi')
                print(result == bytearray(b'magic phrase:'))
